...
_serverInfoString = format ["<t color='#A0FFFFFF'>A3Wasteland v1.2 #%1 %2</t>", call A3W_extDB_ServerID, worldName];
...
_generalInfoString = "Website: <t color='#0091CD'><a href='http://gamersinc.net/'> GamersINC </a></t> Forums: <t color='#0091CD'><a href='http://gamersinc.net/rules/'> GamersINC Forums </a></t> TeamSpeak3: ts.gamersinc.co.za";
