...
GVAR(deleteClassesConfig) = [
	[60, ["WeaponHolder","GroundWeaponHolder","WeaponHolderSimulated"]],
	[30*60, ["TimeBombCore"]],
	[3*60, ["SmokeShell"]],
	[60, ["CraterLong_small","CraterLong"]],
	[60, ["AGM_SpareWheel","AGM_JerryCan","AGM_SpareTrack","AGM_FastRoping_Helper","Land_BakedBeans_F","Land_BottlePlastic_V1_F","Land_Suitcase_F","water","cannedfood","repairkit00"]],
	[60, ["#dynamicsound","#destructioneffects","#track","#particlesource"]]
];

GVAR(resetTimeIfPlayerIsWithin) = 30 // how far away from object player needs to be so it can delete
