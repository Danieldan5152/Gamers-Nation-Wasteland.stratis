...
_setupObjects =
{
	...
	_missionHintText = format ["Terpy's Peanutbutters driving a <t color='%2'>%1</t> are moving Peanuts around Stratis. Stop them quickly!", _vehicleName, sideMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "You have stopped the Terpy's Peanuts but they blew up their car! The Peanuts are yours to take!";
};
