...
switch (true) do
{
	...
	case (_class == "I_Heli_light_03_F"):
	{
		// Add 25mm Shells and flares to Hellcat's
		_vehicle addWeaponTurret ["CMFlareLauncher", [-1]];
		_vehicle addMagazineTurret ["120Rnd_CMFlare_Chaff_Magazine", [-1]];
		_vehicle addWeaponTurret ["gatling_25mm", [-1]];
		_vehicle addMagazineTurret ["1000Rnd_25mm_shells", [-1]];
	};
