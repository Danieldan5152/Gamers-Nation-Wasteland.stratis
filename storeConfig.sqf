...
[
    ...
    ["Mk30 HMG .50 High tripod (NATO)", "B_HMG_01_high_F", 34000],
	["Mk30 HMG .50 High tripod (CSAT)", "O_HMG_01_high_F", 34000],
	["Mk30 HMG .50 High tripod (AAF)", "I_HMG_01_high_F", 34000],
    ...
    ["Mk32 GMG 20mm High tripod (NATO)", "B_GMG_01_high_F", 37000],
	["Mk32 GMG 20mm High tripod (CSAT)", "O_GMG_01_high_F", 37000],
	["Mk32 GMG 20mm High tripod (AAF)", "I_GMG_01_high_F", 37000],
	["Mk6 Mortar (NATO)", "B_Mortar_01_F", 150000],
	["Mk6 Mortar (CSAT)", "O_Mortar_01_F", 150000],
	["Mk6 Mortar (AAF)", "I_Mortar_01_F", 150000]
];
...
[
	...
	["NVS", "optic_NVS", 11500, "item"],
	["TWS", "optic_tws", 27500, "item"],
	["TWS MG", "optic_tws_mg", 28500, "item"],
...
[
	...
	["Basketball Court", "Land_BC_Court_F", 100000, "object"],
...
[
	...
	["Fuel Truck", "C_Van_01_fuel_F", 22000, "vehicle"],
	["Fuel Truck (Camo)", "B_G_Van_01_fuel_F", 22100, "vehicle"],
...
[
	...
	["M2A1 Slammer", "B_MBT_01_cannon_F", 85000, "vehicle"],
...
[
	...
	["Mi-290 Taru (Repair) [DLC]", "O_Heli_Transport_04_repair_F", 115000, "vehicle"],
	["Mi-290 Taru (Ammo) [DLC]", "O_Heli_Transport_04_ammo_F", 125000, "vehicle"],
	...
	["Mi-48 Kajman (Black)", "O_Heli_Attack_02_black_F", 95000, "vehicle"] // Mi-28 with gunner (black camo)
];
...
[
	...
	["To-199 Neophron CAS", "O_Plane_CAS_02_F", 125000, "vehicle"],
	["A-164 Wipeout CAS", "B_Plane_CAS_01_F", 125000, "vehicle"],
	...
	["K40 Ababil-3 Missile UAV (AAF)", "I_UAV_02_F", 30000, "vehicle"],
...
[
	...
	[ // MH-9 colors
		...
		[
			...
			["RedBull (MH-9)", _texDir + "Redbull.jpg"],
			["Army (MH-9)", _texDir + "Woodlands.jpg"]
        ]
	],
	[ // Mohawk colors
	...
	[ // Hellcat colors
		"I_Heli_light_03_F",
		[
			["Hellcat Navy", _texDir + "blackcats.jpg"]
		]
	],
	[ // Taru bench colors
